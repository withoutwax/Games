...
// DISPLAY HIGHSCORE
db.collection("click").orderBy("score").onSnapshot(function (snapshot) {
...
function gotData(data) {
  ...
  var score_list = data; // console.log(score_list);
  // OUTPUT HIGHSCORE =================

  for (var i = 0; i < 10; i++) {
    // console.log(score_list[i].data());
    var name = score_list[i].data().name; // console.log(name, name.length);

    if (name.length > 10) {
      name = name.substring(0, 10);
    }

    var score = score_list[i].data().score; // console.log(score);
